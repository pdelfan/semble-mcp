  ...
  return {
    client: {
      ...
      collections: {
        ...
        collectionByAtUri: ok,
        collectionFollowers: ok,
        collectionFollowersCount: ok,
        collectionContributors: ok,
        openWithContributor: ok,
        updateCollection: ok,
        deleteCollection: ok,
      },
      users: {
        ...
        followingCount: ok,
        userFollowersCount: ok,
        followingCollectionsCount: ok,
      },
